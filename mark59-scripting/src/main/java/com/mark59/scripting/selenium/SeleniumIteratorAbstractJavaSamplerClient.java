 ...
 */
public abstract class SeleniumIteratorAbstractJavaSamplerClient extends SeleniumAbstractJavaSamplerClient implements UIiterator {
	...
	static {
		...
		staticMap.putAll(buildBaseSeleniumStaticArgsMap());
		
		seleniumDefaultIteratorArgumentsMap = Collections.unmodifiableMap(staticMap);
	}
	...
	public Arguments getDefaultParameters() {
		return Mark59Utils.mergeMapWithAnOverrideMap(seleniumDefaultIteratorArgumentsMap, additionalTestParameters());
	}
